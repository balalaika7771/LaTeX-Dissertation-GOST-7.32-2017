...
\begin{CodeBlock}{Python}{Пример Python кода с улучшенной подсветкой}{lst:python_enhanced2}
def calculate_sum(a, b):
    """Calculate sum of two numbers"""
    return a + b
...
\begin{equation}
E = mc^2
\label{eq:appendix2_einstein}
\end{equation}

Согласно формуле \ref{eq:appendix2_einstein} энергия пропорциональна массе.
